...
typedef enum {
	...
	REQUEST_POWER_KNOB_GET_INFO, /* 1023 */
	RESPONSE_POWER_KNOB_GET_INFO,
	REQUEST_POWER_KNOB_GET_CACHE_INFO,
	RESPONSE_POWER_KNOB_GET_CACHE_INFO,
	REQUEST_POWER_KNOB_SET,
	RESPONSE_POWER_KNOB_SET,
	REQUEST_POWER_CAP_SET,
	RESPONSE_POWER_CAP_SET,
	REQUEST_POWER_SCHEDULE_SLURMD,
	RESPONSE_POWER_SCHEDULE_SLURMD,
