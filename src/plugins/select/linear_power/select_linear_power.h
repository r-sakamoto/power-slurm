...
//#define TOTAL_POWER_LIMIT (100360)
//#define TOTAL_POWER_LIMIT (125450)
//#define TOTAL_POWER_LIMIT (150540)
//#define CORE_NUM_SOCK (12)
//#define TOTAL_NODE_NUM (965)

//#define IDLE_NODE_CPU_POWER (80)
//#define IDLE_NODE_MEM_POWER (0)

/*
#define TOTAL_POWER_LIMIT (750)
#define CORE_NUM_SOCK (8)
...
//#define IDLE_NODE_POWER (IDLE_NODE_CPU_POWER + IDLE_NODE_MEM_POWER) // only cpu
