/*****************************************************************************\
 *  power_schedule_slurmd_none.c - power schedule_slurmd plugin for none
 *****************************************************************************
...
const char		plugin_name[]	= "SLURM Power schedule_slurmd plugin";
const char		plugin_type[]	= "power_schedule_slurmd/none";
...
int init( void )
{
	...
	verbose( "power schedule: Power schedule_slurmd plugin loaded" );
